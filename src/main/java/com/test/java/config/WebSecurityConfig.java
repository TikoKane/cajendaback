    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable().cors().and()
                // dont authenticate this particular request
                    .authorizeRequests().antMatchers("/login","/allBonReduction","/createRole","/getUtilisateurByEmail/{email}","/getBonByCode/{code}","/allPaiements","/createAstuce","/AstuceyId/{id}","/allAstuce","/DeleteAstuceById/{id}","/updatePaiement/{id}","/GetPaiementById/{id}","/DeletePaiementById/{id}","/createQuestion","/createQuestion/{Question}/{admin}","/activeCompte/{id}","/desactiveCompte/{id}","/allReponses","/GetReponseById/{id}","/allSousReponses","/createReponse","/createSousReponse","/GetSousReponseById/{id}","/allTypeAbonnement","/createTypeAbonnement","/GetTypeAbonnementById/{id}","/allUsers","/upload","/deletefiles/{id}","/files","/files/{id}","/DeleteReponseById/{id}","/GetUserById/{id}","/updateAstuce/{id}/{libelle}/{admin}","/addUserClient","/updateQuestion/{id}/{Question}/{admin}","/GetQuestionById/{id}","/sousreponsesByIdReponse/{id}","/allAdmin","/ingredientsByIdReponse/{id}","/createBonReduction/{pourcentage}/{admin}","/questionByReponse/{id}","/allAbonnement","/allQuestions","/DeleteQuestionById/{id}","/updateAdmin/{id}","/createAdmin","/createBonReduction","/allIngredients","/createIngredient","/updateIngredient/{id}","/DeleteIngredientById/{id}","/GetIngredientById/{id}","/GetBonReductionById/{id}","/DeleteBonReductionById/{id}","/AstuceyId/{id}","/updateBonReduction/{id}","/GetAbonnementById/{id}","/DeleteAbonnementById/{id}","/createAbonnement","/DeleteAdminById/{id}","/updateAbonnement/{id}","/allTypePaiement","/DeleteTypePaiementById/{id}","updateTypeAbonnement/{id}","/GetAdminById/{id}","/GetTypePaiementById/{id}","/createTypePaiement","/updateTypePaiement/{id}").permitAll().
